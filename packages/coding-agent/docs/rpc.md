...
```json
{"type":"message_update","assistantMessageEvent":{"type":"text_start","contentIndex":0},"usage":{...}}
{"type":"message_update","assistantMessageEvent":{"type":"text_delta","contentIndex":0,"delta":"Hello"},"usage":{...}}
{"type":"message_update","assistantMessageEvent":{"type":"text_delta","contentIndex":0,"delta":" world"},"usage":{...}}
{"type":"message_update","assistantMessageEvent":{"type":"text_end","contentIndex":0,"content":"Hello world"},"usage":{...}}
```
...
contains the completed call. The top-level `usage` field carries the current
provider-reported usage without restoring a cumulative message snapshot.
